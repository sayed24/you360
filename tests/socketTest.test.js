	...
	it('Should broadcast new video',function(done){
		...
		try{
			...
			var checkvideoid = function(client){
				client.on('videos count', function(){
					//console.log(video)
		        	client.disconnect();
		        	count++;
		        	if(count === 2){
			...
			var checkvideoid2 = function(client){
				client.on('vaiolated videos count', function(){
					//console.log(video)
		        	client.disconnect();
		        	count++;
		        	if(count === 2){
			...
			client1.on('connect', function(data){
				...
				client2.on('connect', function(data){
					...
					// 	checkvideoid(client3);
	  					client2.emit('get violated videos count')
	  				//end of client3
	  				// });
	  			//end of client2	
				});
